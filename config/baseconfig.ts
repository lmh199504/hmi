...
const baseconfig: IConfigFromPlugins | IConfig = {
  ...
  keepalive: [
    "/source/areaData/location",
    "/source/areaData/port",
    "/source/areaData/pricingArea",
    "/source/cntData/cntSize",
    "/source/cntRepairData/cntMaterial",
    "/source/cntRepairData/locationCode",
    "/source/cntRepairData/componentCode",
    "/source/cntRepairData/damageType",
    "/source/cntRepairData/damageCode",
    "/source/cntRepairData/repairCode",
    "/source/cntRepairData/cntCondition",
    "/source/controlData/yard",
    "/source/controlData/moveBox",
    "/source/controlData/moveBox",
    "/source/controlData/tenantMoveBox",
    "/source/customerData/customer",
    "/source/customerData/producer",
    "/source/transport/shipDynamics",
    "/source/areaData/port",
    "/source/areaData/location",
    "/source/areaData/pricingArea",
    "/source/systemConfig/product",
    "/source/dictData/dict",
  ],
  chainWebpack: (config) => {
